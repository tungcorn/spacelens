...
dynamically shipped with SpaceLens 0.1.10. It is not legal advice.
...
`spacelens-v0.1.10-windows-x64.zip`, for as long as SpaceLens continues
...
v0.1.9 unified archive `spacelens-v0.1.9-windows-x64.zip`, the
historical v0.1.8 unified archive `spacelens-v0.1.8-windows-x64.zip`, the
...
Do not put the ~1 GB source archive inside the unified runtime zip.
