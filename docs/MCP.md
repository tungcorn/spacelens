...
Product version stays **0.1.2**. The MCP binary is built from source
(`SPACELENS_BUILD_MCP`, default ON) and is **not** installed into the
published v0.1.2 zip or npm package.
