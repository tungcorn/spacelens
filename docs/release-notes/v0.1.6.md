...
v0.1.5 stays published and immutable. This is a new tag, new assets, and
`@tungcorn/spacelens@0.1.6`.
...
| Asset | Use |
| --- | --- |
| [spacelens-v0.1.6-windows-x64.zip](https://github.com/tungcorn/spacelens/releases/download/v0.1.6/spacelens-v0.1.6-windows-x64.zip) | Recommended: GUI + CLI + MCP (Qt 6.8.3 runtime included) |
| [spacelens-cli-v0.1.6-windows-x64.zip](https://github.com/tungcorn/spacelens/releases/download/v0.1.6/spacelens-cli-v0.1.6-windows-x64.zip) | Headless: CLI + MCP, no GUI, no Qt |
| [SHA256SUMS.txt](https://github.com/tungcorn/spacelens/releases/download/v0.1.6/SHA256SUMS.txt) | SHA-256 of the attached zips |
